<template>
    <div class="producty">
        <div class="details">
            <img src="../assets/products/closets/omad1x1.jpg" alt="Rasm yuklana olmadi, qayta urining">
        </div>
        ...
        <p>
            ...
            <span class="indicated">55sm</span>
        </p>
        <p>
        ...
        <p class="price">
            ...
            <span class="indicated">6 300 000 so'm</span> 
