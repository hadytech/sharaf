<template>
    <div class="producty">
        <div class="details">
            <img src="../assets/products/closets/bahor_1x1.jpg" alt="Rasm yuklana olmadi, qayta urining">
        </div>
        ...
        <p>
            ...
            <span class="indicated">245sm</span>
        </p>
        <p>
            <span class="indicator">Eni:</span>
            <span class="indicated">190sm</span>
        </p>
        <p>
            <span class="indicator">Chuqurlik:</span>
            <span class="indicated">60sm</span>
        </p>
        <p>
            <span class="indicator">Xomashyo:</span>
            <span class="indicated">LDSP,   LMDF</span>
        </p>

        <hr>
        <p class="price">
            <span class="indicator">Narxi:</span>
            <span class="indicated">3 800 000 so'm</span> 
