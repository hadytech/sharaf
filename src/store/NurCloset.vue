<template>
    <div class="producty">
        <div class="details">
            <img src="../assets/products/closets/nur1x1.jpg" alt="Rasm yuklana olmadi, qayta urining">
        </div>
        ...
        <p>
            ...
            <span class="indicated">175sm</span>
        </p>
        <p>
        ...
        <p class="price">
            ...
            <span class="indicated">2 800 000 so'm</span> 
