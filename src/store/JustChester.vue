<template>
    <div class="producty">
        <div class="details">
            <img src="../assets/products/chester/chester1x1.jpg" alt="Rasm yuklana olmadi, qayta urining">
        </div>
        ...
        <p>
            ...
            <span class="indicated">40sm</span>
        </p>
        <p>
        ...
        <p class="price">
            ...
            <span class="indicated">990 000 so'm</span> 
