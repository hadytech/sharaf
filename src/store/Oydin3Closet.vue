<template>
    <div class="producty">
        <div class="details">
            <img src="../assets/products/closets/oydin3_1x1.jpg" alt="Rasm yuklana olmadi, qayta urining">
        </div>
        <div class="veryDetails">
            <h2>"Oydin 3" shkafi</h2>
            <h3>Ma'lumotlar:</h3>
        <!-- <p>
            <span class="indicator">Fasad:</span>
            <span class="indicated">akril</span>
        </p> -->
        <p>
            <span class="indicator">Bo`yi:</span>
            <span class="indicated">210sm</span>
        </p>
        <p>
            <span class="indicator">Eni:</span>
            <span class="indicated">130sm</span>
        </p>
        <p>
            <span class="indicator">Chuqurlik:</span>
            <span class="indicated">58sm</span>
        </p>
        <p>
            <span class="indicator">Xomashyo:</span>
            <span class="indicated">LDSP</span>
        </p>

        <hr>
        <p class="price">
            <span class="indicator">Narxi:</span>
            <span class="indicated">2 900 000 so'm</span> 
