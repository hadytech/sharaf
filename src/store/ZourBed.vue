<template>
    <div class="producty">
        <div class="details">
            <img src="../assets/products/beds/zour1x1.jpg" alt="Rasm yuklana olmadi, qayta urining">
        </div>
        <div class="veryDetails">
            <h2>"Zo'r 2" krovati</h2>
            <h3>Ma'lumotlar:</h3>
        <!-- <p>
        ...
        <p>
            ...
            <span class="indicated">86sm</span>
        </p>
        <p>
            <span class="indicator">Chuqurlik:</span>
            <span class="indicated">93sm</span>
        </p>
        <p>
