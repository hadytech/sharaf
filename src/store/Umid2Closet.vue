<template>
    <div class="producty">
        <div class="details">
            <img src="../assets/products/closets/umid2_1x1.jpg" alt="Rasm yuklana olmadi, qayta urining">
        </div>
        ...
        <p>
            ...
            <span class="indicated">240sm</span>
        </p>
        <p>
            <span class="indicator">Eni:</span>
            <span class="indicated">146sm</span>
        </p>
        <p>
        ...
        <p class="price">
            ...
            <span class="indicated">2 600 000 so'm</span> 
