<template>
    <div class="producty">
        <div class="details">
            <img src="../assets/products/beds/qobil2_1x1.jpg" alt="Rasm yuklana olmadi, qayta urining">
        </div>
        <div class="veryDetails">
            <h2>"Qobil 2" krovati</h2>
            <h3>Ma'lumotlar:</h3>
        <!-- <p>
        ...
        <p>
            ...
            <span class="indicated">205sm</span>
        </p>
        <p>
            <span class="indicator">Eni:</span>
            <span class="indicated">90sm</span>
        </p>
        <p>
            <span class="indicator">Chuqurlik:</span>
            <span class="indicated">110sm</span>
        </p>
        <p>
