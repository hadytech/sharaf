<template>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><img src="../assets/logo.png" alt=""> Sharaf Mebel</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="/"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5" width="18px">
...
Asosiy</a>
        ...
        <li class="nav-item">
          <a class="nav-link" href="/closet"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5" width="18px">
...
Shkaf</a>
        ...
        <li class="nav-item">
          <a class="nav-link" href="/bed"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5" width="18px">
...
Boshqa
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="#">Tumbochka</a></li>
            <li><a class="dropdown-item" href="#">Chester</a></li>
          </ul>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/serve"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5" width="18px">
...
Xizmat</a>
        ...
        <li class="nav-item">
            <a class="nav-link" href="/about"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5" width="18px">
...
Bog'lanish</a>
      ...
      <form class="d-flex" role="search">
        <input class="form-control me-2" type="search" placeholder="Kiriting" v-model="search_input" aria-label="Search">
        <button type="submit" @click="search_product">Izlash</button>
      </form>
    </div>
  </div>
</nav>
...
export default{
  ...
  methods:{
    search_product(){
      this.$root.$emit('searchProduct',this.search_input)
    }
  }
}
</script>
